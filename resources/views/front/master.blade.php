                    ...
                    <div class="row">
                        <div class="col-xs-12 text-center menu-1">
                            <ul>
                                ...
                                <li class="@if(request()->routeIs('service')) active @endif"><a href="{{ route('service') }}">Services</a></li>
                                <li class="@if(request()->routeIs('portfolio')) active @endif"><a href="{{ route('portfolio') }}">Portfolio</a></li>
